...
# There is also no need to set the K6_BROWSER_ENABLED and K6_BROWSER_HEADLESS variable explicitly since this is already
# defined in the Dockerfile and are both set to true. 
